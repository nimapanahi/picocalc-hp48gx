...
identifiers, for example `1.0.0-rc.6`; Git tags add the conventional `v`
prefix: `v1.0.0-rc.6`.
...
5. Confirm that Git contains no ROM, unpacked ROM, saved state, or
   ROM-containing UF2.
6. Commit, create an annotated tag such as `v1.0.0-rc.6`, and push both.
7. Create a GitHub prerelease from the tag. Attach the ROM-free template,
   builder scripts or builder archive, and SHA-256 checksums. Never attach an
   HP ROM or ROM-containing UF2 unless explicit redistribution permission has
